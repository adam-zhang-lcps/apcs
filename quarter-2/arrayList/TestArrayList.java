...
public class TestArrayList {
  ...
  public static void main(String[] args) {
     ...
     * Note printArray calls the ArrayList methods: get(index) and size(), so
     * start off implementing the constructors, size, get, and add.
     */
    ...
    /* ==================================================================================
     *  Test the add: forcing the ArrayList to increase the size of the internal
     * array.
     * ==================================================================================
     */
    ...
    printTestHeader(
        testCount++,
        "add several more elements forcing a call to expandArray()");
    for (int k = 0; k < 10; k++)
      myList.add(k + 5);
     ...
     */
    printTestHeader(testCount++,
                    "test removes, the last element, the first, the middle ");
