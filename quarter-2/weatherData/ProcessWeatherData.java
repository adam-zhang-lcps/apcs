...
public class ProcessWeatherData {
    ...
    public static void main(String[] args) {
        ...
        ds.load();
        ArrayList<WeatherStation> allStations = ds.fetchList(
            "WeatherStation", "station/station_name", "station/station_id",
         ...
         *   - If so:
         *         - get the URL from the WeatherStation  (call the
         accessor/getter)
         *         - use the same code above to read in the data into the
         *           StationObservation object
         *           => note: use similar process as above, but use fetch()
         instead
        ...
        for (WeatherStation ws : allStations) {
            ...
            try {
                ...
                StationObservation stationObs =
                    ds2.fetch("StationObservation", "temp_f",
                              "relative_humidity", "dewpoint_f");
