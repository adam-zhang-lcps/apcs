public class ArraysReview {
    /*
     * countOdd_Over50 input: an array of integers output: a count of elements that
     * are odd AND greater than 50
     *
     * countOdd_Over50 ( {6, 51, 90, 61, 12, 14} ) => 2
     *
     * create and initialize a count variable to 0. traverse the list and test for
     * odd AND over 50 to test for 2 conditions use the && (and) operator
     *
     * return the count
     */
     ...
     *
     * set a variable, min, to the first element traverse the list and compare each
     * element with the current minimum if an element is less than, set the current
     * min to that value
     *
     * return the min
     */
    ...
    /*
     * replaceNegatives input: an array of integers output: absolute value of all
     * elements
     *
    ...
    /*
     * removeNegatives input: an array of integers output: an array of integers with
    ...
    public static int[] removeNegatives(int[] a) {
        ...
        /*
         * traverse the original array, a, store positive elements into array b at
         * index. after you store the positive element, increment index.
         */
        for (int x : a) {
            if (x > 0) {
                b[index] = x;
    ...
    /*
     * getMedian: return the median of a sorted array of integers input: an array of
     * sorted integers output: double - median value
     *
     * if the length of the array is odd, return the middle element if the length of
     * the array is even, return the average of the 2 middle elements
     *
     ...
     * numbers
     *
     * if the length of the array is odd - return the middle number (note: need to
     * typecast the element to a double)
     */
    ...
    /*
     * calculateAverage input: an array of integers output: double - average value
     *
    ...
    /*
     * Uncomment the sections of code in main after you have finished writing the
     * corresponding methods above. I recommend you write a method, then test it.
     * Don't try to write all methods first.
     */
    ...
    public static void main(String[] args) {
        ...
        printArray("my2ndArray after populating it with a range of 100 and an offset of 10", my2ndArray);
     ...
     *
     * display all elements within an array, 4 spaces per element print a new line
     * after every 10 elements
     */
     ...
     *
     * if the range is 100 and the offset is 10 then the elements should be between
     * 10 and 109
     *
     * you do not have to return anything. You are passed a reference to an array
     * and you are modifying the elements of the array.
     */
